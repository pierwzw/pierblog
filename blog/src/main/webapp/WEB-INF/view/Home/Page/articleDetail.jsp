...
<rapid:override name="left">
    <%--博客主体-左侧文章正文 start--%>
    <div id="primary" class="content-area article-detail">
                ...
                <div class="entry-content">
                    ...
                    <div id="social">
                        <div class="social-main">
                            ...
                            <%--百度分享： http://share.baidu.com/code/advance --%>
                            <div class="share-sd">
                    ...
                    <footer class="single-footer">
                            ...
                            <%--<c:if test="${sessionScope.user!=null && sessionScope.user.userId==article.articleUserId}">--%>
                                <li class="edit-link">
                                    <a target="_blank" class="post-edit-link"
                                       href="http://www.pierwzw.top/admin/article/edit/${article.articleId}">编辑</a>
                                </li>
                            <%--</c:if>--%>
                            <li class="comment">
                        ...
                        <div class="single-cat-tag">
                            <div class="single-cat" style="float: left">所属分类：
                                <c:forEach items="${article.categoryList}" var="c">
                                    <a href="/category/${c.categoryId}">
                                            ${c.categoryName}
                                    </a>
                            ...
                            <div class="single-tag" style="float: left">所属标签：
                    ...
                    <li class="reprinted"><strong>转载请注明：</strong>
                        <a href="/article/${article.articleId}"
                           ...
                           title="本文固定链接 /article/${article.articleId}">
                                www.pierwzw.top/article/${article.articleId} | ${options.optionSiteTitle}</a>
                    </li>
                </ul>
                <div class="clear"></div>
            </div>
                ...
                <div id="respond" class="comment-respond">
                    ...
                    <form id="comment_form" method="post">
                        <c:if test="${sessionScope.user!=null}">
                            <div class="user_avatar">
                                ...
                                <input type="hidden" name="commentAuthorEmail"
                                       value="${sessionScope.user.getUserEmail()==null?sessionScope.user.getUserNickname():sessionScope.user.getUserEmail()}">
                        ...
                        <p class="comment-form-comment">
                            <textarea oninput="checksum(200)" id="comment" name="commentContent" rows="4" tabindex="1" required ></textarea>
                            <div class="input_can" style="float: right;"></div>
                        </p>
                        ...
                        <%--<c:if test="${c.commentPid == 0}">--%>
                            ...
                            <li class="comment comment-fa">
                                            ...
                                            <li class="comment comment-ch">
                                                <div id="div-comment-${c.commentId}" class="comment-body">
                                                    <div class="comment-author vcard">
                                                        ...
                                                        <span class="comment-ex">
                                                            [${c2.location}网友 ${c2.browser} ${c2.os}]
                                                        </span>
                                                ...
                                                <span class="reply" style="float: right;">
                                                    ...
                                                    <c:if test="${sessionScope.user != null && sessionScope.user.userName == 'pierwzw'}}">
                                                        <a href="javascript:void(0)" onclick="deleteComment(${c2.commentId})">
                                                            删除
                                                        </a>
                                                        <%--<a class="comment-edit-link" href="/admin/comment/edit/${c2.commentId}" target="_blank">
                                                            编辑
                                                        </a>--%>
                                                    </c:if>
                                                </span>
                                ...
                                <span class="reply" style="float: right;">
                                    ...
                                    <c:if test="${sessionScope.user != null && sessionScope.user.userName == c.commentAuthorName}">
                                        <a href="javascript:void(0)" onclick="deleteComment(${c.commentId})">
                                            删除
                                        </a>
                                        <%--<a class="comment-edit-link" href="/admin/comment/edit/${c.commentId}" target="_blank">
                                            编辑
                                        </a>--%>
                                    </c:if>
                                </span>
...
<rapid:override name="footer-script">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("input[name='location']").val(returnCitySN["cname"]);
            $("input[name='browser']").val(Browser.client.name + '/' + Browser.client.version);
            $("input[name='os']").val(getOS());
        });
       ...
       /* layui.code({
        ...
        function checksum(sum) {
            var inputedNum = $("#comment").val().length;     //这里可以用input,也可以keyup,总之就是事件监听
            ...
            if (canInputNum > 0) {
                ...
                $("#comment").val($("#comment").val().substring(0, sum));    //当输入500字后 无法再输入
            }
        }
    </script>
