        ...
        <div id="feed_widget">
            <div class="feed-about">
                <div class="about-main">
                    ...
                    <div class="about-name" style="margin-top: 10px">${options.optionAboutsiteTitle}</div>
                    <div class="about-the">
                ...
                <ul>
                    ...
                    <li class="tqq">
                        ...
                        <a target="_blank" rel="external nofollow"
                           href="http://wpa.qq.com/msgrd?v=3&uin=${options.optionAboutsiteQq}&site=qq&menu=yes">
                            <%--<img border="0" src="http://wpa.qq.com/pa?p=2::52" alt="联系我吧" title="联系我吧"/>--%>
                            <i class="fa fa-qq"></i>
                        </a>
                    </li>
                    <li class="tsina">
            ...
            <c:forEach items="${allTagList}" var="tag">
                <c:if test="${tag.articleCount > 0}">
                    <a href="/tag/${tag.tagId}"
                       ...
                       style="font-size: ${tag.articleCount+13}px;">
