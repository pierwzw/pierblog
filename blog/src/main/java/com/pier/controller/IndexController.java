...
import com.pier.enums.LinkStatus;
import com.pier.enums.NoticeStatus;
...
public class IndexController {
    ...
    public String index(@RequestParam(required = false, defaultValue = "1") Integer pageIndex,
        ...
        //侧边栏显示
        //标签列表显示
        List<Tag> allTagList = tagService.listTagWithCount();
    ...
    @RequestMapping("/404")
    public String NotFound(@RequestParam String message, Model model) {
        model.addAttribute("message", message);
        return "Home/Error/404";
    }

    @RequestMapping("/500")
    public String ServerError(@RequestParam String message, Model model) {
        model.addAttribute("message", message);
