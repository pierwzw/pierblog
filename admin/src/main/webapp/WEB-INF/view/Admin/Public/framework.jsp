...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-side layui-bg-black">
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree"  lay-filter="test">
                ...
                <li class="layui-nav-item open-all">
                    <a href="javascript:;">页面</a>
                    <dl class="layui-nav-child">
                        <dd><a href="/admin/page" onclick="openall(this)">&nbsp;&nbsp;全部页面</a></dd>
    ...
    <div class="layui-footer">
        <!-- 底部固定区域 -->
        © <a href="http://blog.pierwzw.com">zhongweiwu博客</a> 2017  欢迎加入开发者交流群 590480292，博主免费回答大家日常问题。同时博主代做毕设，解决开发问题，详情参看 <a href="https://pierwzw.com/bulletin/my-service/" target="_blank">有偿服务</a>
    </div>
</div>
...
<script>
    ...
    function openall(obj){
       var page = $(obj).parents("li").attr("class","afdafdas");
       /*alert(page);*/
    }
</script>
