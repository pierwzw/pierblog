...
<rapid:override name="content">
    ...
    <form class="layui-form" method="post" id="myForm" action="/admin/article/editSubmit">
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea class="layui-textarea layui-hide" name="articleContent"
                          id="editor">${article.articleContent}</textarea>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select style="display: none;" name="articleParentCategoryId" id="articleParentCategoryId"
            ...
            <div class="layui-input-inline">
                <select style="display: none;" name="articleChildCategoryId" id="articleChildCategoryId" lay-filter="articleChildCategoryId">
                    <c:forEach items="${categoryList}" var="c">
        ...
        <div class="layui-form-item" pane="">
            ...
            <div class="layui-input-block">
                <c:forEach items="${tagList}" var="t">
                    <input style="display: none;" type="checkbox" name="articleTagIds" lay-skin="primary" title="${t.tagName}"
                           value="${t.tagId}"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input style="display: none;" type="radio" name="articleStatus" value="1" title="发布"
    ...
    <blockquote class="layui-elem-quote layui-quote-nm">
        温馨提示：
        1、插入代码前，可以点击 <a href="http://pierwzw.com/code-highlight.html" target="_blank">代码高亮</a>,将代码转成HTML格式
    </blockquote>
